...
class DataProviderBase(MLEntityBase):
    ...
    def prepare_data_pandas(self, features, target_feature):
        import pandas as pd
        if (self.dataset_name.lower() == 'gapminder'):
            ...
            raise TypeError(
                f'The dataset: {self.dataset_name} is not supported in the framework: {self.framework_name}')

    def prepare_data_sklearn(self, features, sample_size):
        if (self.dataset_name.lower() == 'imdb'):
        ...
        elif self.dataset_name.lower() == 'ca_housing':
            housing = datasets.fetch_california_housing()
            self.prepare_dataset(housing, features)
        else:
            raise TypeError(self.log(f'The dataset {self.dataset_name} is not supported'))
